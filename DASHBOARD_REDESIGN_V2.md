# DASHBOARD_REDESIGN_V2

Viru — Rediseño profesional del Dashboard (Jerarquía, foco y limpieza)

## 0. Objetivo
Transformar el dashboard actual en:
- Más jerárquico
- Más enfocado en acción
- Más limpio visualmente
- Más intuitivo
- Menos redundante
- Más profesional

NO añadir nuevas funcionalidades complejas. Reorganizar, fusionar, priorizar y mejorar UX.

Referencia del estado actual: Dashboard mostrado en PDF reciente.

---

## 1. Problema estructural actual
- Demasiadas tarjetas con el mismo peso visual.
- Recomendaciones y Sugerencias duplican intención.
- Notas ocupan demasiado espacio para ser secundarias.
- No existe bloque dominante.
- Exceso de botones secundarios.
- Falta un “qué hago ahora”.
