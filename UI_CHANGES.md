# UI_CHANGES.md
Viru — UI / UX Correcciones y Reestructuración General  
Documento de instrucciones para Codex

---

## 0. Objetivo General

Corregir problemas de jerarquía, claridad, accesibilidad y coherencia visual del producto **Viru**, manteniendo la estética actual (soft UI, tipografía, bordes redondeados) pero elevando el nivel a **SaaS profesional consistente**.

Los cambios afectan a:

- Dashboard / Panel Principal
- Búsqueda Rápida (modo claro y oscuro)
- Componentes compartidos (inputs, botones, cards, banners)
- Sistema de tema claro/oscuro
- Introducción de menú de cuenta arriba a la derecha
- Eliminación o compactación de UI técnica/debug visible

No se debe rediseñar todo.  
Se debe **refinar y reestructurar**.
