...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields on the login page and click the 'Entrar' (submit) button to sign in.
        frame = context.pages[-1]
        # Input text
        ...
        # -> Click the 'Entrar' submit button again to attempt login (use interactive element index 266).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=html/body/main/form/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        ...
        elem = frame.locator("text=Saved").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        assert await elem.is_visible(), "The 'Saved' confirmation was not visible after saving preferences"
